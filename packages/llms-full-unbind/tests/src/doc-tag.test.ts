/**
 * Doc-tag format tests
 *
 * Tests for llms-txt style format: `<doc title="..." desc="...">content</doc>`
...
describe("unbind (doc-tag format)", () => {
...
describe("unbindStream (doc-tag format)", () => {
...
describe("Real-world doc-tag format", () => {

...
/**
 * Parse doc-tag format content synchronously
 */
export function parseDocTagFormat(content: string): Page[] {
  const pages: Page[] = [];
  ...
  while ((match = DOC_TAG_REGEX.exec(content)) !== null) {
...
/**
 * Streaming parser for doc-tag format
 */
export class DocTagStreamingParser implements StreamingParser {
  private buffer = "";
